...
#define FUNCTION_TEST_BEGIN()                                                                                                      \
    FUNCTION_TEST_MEM_CONTEXT_AUDIT_BEGIN();                                                                                       \
                                                                                                                                   \
        /* Ensure FUNCTION_LOG_BEGIN() and FUNCTION_TEST_BEGIN() not both used by declaring same variable */                       \
        /* FUNCTION_LOG_BEGIN() uses to track logging */                                                                           \
    LogLevel FUNCTION_LOG_LEVEL();                                                                                                 \
    (void)FUNCTION_LOG_LEVEL();                                                                                                    \
                                                                                                                                   \
        /* Ensure FUNCTION_TEST_RETURN*() not used with FUNCTION_LOG_BEGIN*() by declaring variable referenced */                  \
